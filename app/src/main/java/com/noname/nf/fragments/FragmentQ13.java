...
// */
public class FragmentQ13 extends Fragment {
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_q13, container, false);

        radioGroupCriteriaCompare1 = view.findViewById(R.id.criteriaCompare13);
        radioButtonGenre = view.findViewById(R.id.genreCheckQ13);
        radioButtonCountry = view.findViewById(R.id.countryCheckQ13);
        integrityLayout = view.findViewById(R.id.integrityLayoutQ13);
        integrityRadio = view.findViewById(R.id.integrityQ13);
        inte1 = view.findViewById(R.id.oneQ13);
        inte2 = view.findViewById(R.id.twoQ13);
        inte3 = view.findViewById(R.id.threeQ13);
        inte4 = view.findViewById(R.id.fourQ13);
        inte5 = view.findViewById(R.id.fiveQ13);
        inte6 = view.findViewById(R.id.sixQ13);
        inte7 = view.findViewById(R.id.sevenQ13);
        inte8 = view.findViewById(R.id.eightQ13);
        inte9 = view.findViewById(R.id.nineQ13);
    ...
    public static String getCriteriaQuestion13() { return criteriaSelected; }
    public static float getIntegrityQuestion13() { return integrity; }
}