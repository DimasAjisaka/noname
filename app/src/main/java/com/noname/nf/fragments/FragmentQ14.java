...
// */
public class FragmentQ14 extends Fragment {
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        radioGroupCriteriaCompare1 = view.findViewById(R.id.criteriaCompare14);
        radioButtonGenre = view.findViewById(R.id.genreCheckQ14);
        radioButtonCountry = view.findViewById(R.id.countryCheckQ14);
        integrityLayout = view.findViewById(R.id.integrityLayoutQ14);
        integrityRadio = view.findViewById(R.id.integrityQ14);
        inte1 = view.findViewById(R.id.oneQ14);
        inte2 = view.findViewById(R.id.twoQ14);
        inte3 = view.findViewById(R.id.threeQ14);
        inte4 = view.findViewById(R.id.fourQ14);
        inte5 = view.findViewById(R.id.fiveQ14);
        inte6 = view.findViewById(R.id.sixQ14);
        inte7 = view.findViewById(R.id.sevenQ14);
        inte8 = view.findViewById(R.id.eightQ14);
        inte9 = view.findViewById(R.id.nineQ14);
    ...
    public static String getCriteriaQuestion14() { return criteriaSelected; }
    public static float getIntegrityQuestion14() { return integrity; }
}