...
// */
public class FragmentQ15 extends Fragment {
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        radioGroupCriteriaCompare1 = view.findViewById(R.id.criteriaCompare15);
        radioButtonGenre = view.findViewById(R.id.genreCheckQ15);
        radioButtonCountry = view.findViewById(R.id.countryCheckQ15);
        integrityLayout = view.findViewById(R.id.integrityLayoutQ15);
        integrityRadio = view.findViewById(R.id.integrityQ15);
        inte1 = view.findViewById(R.id.oneQ15);
        inte2 = view.findViewById(R.id.twoQ15);
        inte3 = view.findViewById(R.id.threeQ15);
        inte4 = view.findViewById(R.id.fourQ15);
        inte5 = view.findViewById(R.id.fiveQ15);
        inte6 = view.findViewById(R.id.sixQ15);
        inte7 = view.findViewById(R.id.sevenQ15);
        inte8 = view.findViewById(R.id.eightQ15);
        inte9 = view.findViewById(R.id.nineQ15);
    ...
    public static String getCriteriaQuestion15() { return criteriaSelected; }
    public static float getIntegrityQuestion15() { return integrity; }
}