...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        radioGroupCriteriaCompare1 = view.findViewById(R.id.criteriaCompare8);
        radioButtonGenre = view.findViewById(R.id.genreCheckQ8);
        radioButtonCountry = view.findViewById(R.id.countryCheckQ8);
        integrityLayout = view.findViewById(R.id.integrityLayoutQ8);
        integrityRadio = view.findViewById(R.id.integrityQ8);
        inte1 = view.findViewById(R.id.oneQ8);
        inte2 = view.findViewById(R.id.twoQ8);
        inte3 = view.findViewById(R.id.threeQ8);
        inte4 = view.findViewById(R.id.fourQ8);
        inte5 = view.findViewById(R.id.fiveQ8);
        inte6 = view.findViewById(R.id.sixQ8);
        inte7 = view.findViewById(R.id.sevenQ8);
        inte8 = view.findViewById(R.id.eightQ8);
        inte9 = view.findViewById(R.id.nineQ8);
    ...
    public static String getCriteriaQuestion8() { return criteriaSelected; }
    public static float getIntegrityQuestion8() { return integrity; }
}