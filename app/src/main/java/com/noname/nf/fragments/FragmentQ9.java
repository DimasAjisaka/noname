...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        radioGroupCriteriaCompare1 = view.findViewById(R.id.criteriaCompare9);
        radioButtonGenre = view.findViewById(R.id.genreCheckQ9);
        radioButtonCountry = view.findViewById(R.id.countryCheckQ9);
        integrityLayout = view.findViewById(R.id.integrityLayoutQ9);
        integrityRadio = view.findViewById(R.id.integrityQ9);
        inte1 = view.findViewById(R.id.oneQ9);
        inte2 = view.findViewById(R.id.twoQ9);
        inte3 = view.findViewById(R.id.threeQ9);
        inte4 = view.findViewById(R.id.fourQ9);
        inte5 = view.findViewById(R.id.fiveQ9);
        inte6 = view.findViewById(R.id.sixQ9);
        inte7 = view.findViewById(R.id.sevenQ9);
        inte8 = view.findViewById(R.id.eightQ9);
        inte9 = view.findViewById(R.id.nineQ9);
    ...
    public static String getCriteriaQuestion9() { return criteriaSelected; }
    public static float getIntegrityQuestion9() { return integrity; }
}