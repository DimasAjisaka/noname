...
import com.noname.nf.utils.PostInputUser;
...
public class Service {
    ...
    private static PostInputUser postInputUser = retrofit.create(PostInputUser.class);

    public static FilmApi getFilmApi() {
        return filmApi;
    }
    public static PostInputUser getPostInputUser() {
